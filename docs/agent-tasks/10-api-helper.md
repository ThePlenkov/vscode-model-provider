...
- create: `apps/extension/src/discovery/cliWrapper.ts`
- create: `apps/extension/src/discovery/cliWrapper.test.ts`
...
- `apps/extension/src/capabilities/`
- `apps/extension/src/provider/` (read-only — must not change PR 09's API)
- `tests/fixtures/`
- `docs/`
